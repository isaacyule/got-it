...
50.times do |iteration|
  ...
  photo = '../app/assets/images/#{IMG[image]}'
  Product.create!(name: name, description: description, condition: condition, price_per_day: price_per_day.sample, deposit: price_per_day.sample/10, handover_fee: handover_fee.sample, user_id: products_user_id, address: address, photo: photo)
